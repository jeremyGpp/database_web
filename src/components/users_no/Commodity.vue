          ...
          <el-col :span="8">
           ...
           <el-col :span="3">
            <el-dropdown @command="handleCommand">
              <el-button class="type_btn" type="primary" size="small" plain>Type<i class="el-icon-arrow-down el-icon--right"></i> </el-button>
      ...
      <span slot="footer" class="dialog-footer">
        <el-form :model="ruleForm" status-icon :rules="loginRules" ref="ruleForm" label-width="100px">
          ...
          <el-form-item label="Type" prop="vtype">
            <el-input type="type" v-model="ruleForm.vtype"></el-input>
          </el-form-item>
